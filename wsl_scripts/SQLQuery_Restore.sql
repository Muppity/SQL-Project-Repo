...
go
RESTORE VERIFYONLY FROM DISK ='/mnt/SQL/MIRROR_DWM_Local_FULL_20180801_203845.bak'
go
RESTORE VERIFYONLY FROM DISK ='/mnt/SQL/MIRROR_Gt_Logistic_FULL_20180801_203845.bak'
go
RESTORE VERIFYONLY FROM DISK ='/mnt/SQL/MIRROR_TSQL2012_FULL_20180801_203846.bak'
go
